...
const ChatLeftElement = ({children}) => {
    ...
    return (
        <div style={{display:"flex", justifyContent: "center", alignItems: "center", margin: 10 }}>
            <MyButton onClick={dispatch(fetchMessages())}><svg  xmlns="http://www.w3.org/2000/svg"  width="36" height="36" fill="currentColor" className="bi bi-person-circle" viewBox="0 0 16 16">
