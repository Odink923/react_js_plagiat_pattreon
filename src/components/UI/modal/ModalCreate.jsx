            ...
            <MyModal visible={modalCreate} setVisible={setModalCreate}>
                <div style={{display: "block"}}>
                    <div style={{display: "inlineBlock", verticalAlign: "top"}}>
                        ...
                        <input style={{ verticalAlign: "top"}} onChange={(e)=>{setCreatePostUrlPhoto(e.target.value)}} name="urlPhoto" placeholder="URL-photo"/>
                    </div>
                    <div style={{display:"inlineBlock", verticalAlign: "top"}}>
                        <input style={{ verticalAlign: "top"}} onChange={(e)=>{setCreatePostTitle(e.target.value)}} name="title" placeholder="Title"/>
                        <input style={{ verticalAlign: "top"}} onChange={(e)=>{setCreatePostDescription(e.target.value)}} name="description" placeholder="description"/>
                        <input style={{ verticalAlign: "top"}} onChange={(e)=>{setCreatePostTags(e.target.value)}} name="tags" placeholder="tags"/>
                    </div>
                    <div>
